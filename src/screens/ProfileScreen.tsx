// 프로필 
//  const [isLoggedIn, setIsLoggedIn] = useState(false) 아래에 개발할땐 true로변경하세요
...
const ProfileScreen = () => {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false) // 개발할땐으로 true로 변경
